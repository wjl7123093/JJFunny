...
import com.snowapp.jjfunny.databinding.ActivityLayoutPreviewBinding;
...
public class PreviewActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static final String KEY_PREVIEW_URL = "preview_url";         // 照片地址
    public static final String KEY_PREVIEW_VIDEO = "preview_video";     // 视频地址
