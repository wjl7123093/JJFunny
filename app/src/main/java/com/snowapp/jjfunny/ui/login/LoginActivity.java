package com.snowapp.jjfunny.ui.login;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void login() {
        if (tencent == null) {
            tencent = Tencent.createInstance("1110985000", getApplicationContext());
        }
    ...
    private void save(String nickname, String avatar, String qqOpenId, long expires_time) {
        ApiService.get("/user/insert")
                .addParam("qqOpenId", qqOpenId)
