...
import com.snowapp.jjfunny.databinding.ActivityLayoutCaptureBinding;
import com.snowapp.jjfunny.view.RecordView;
...
public class CaptureActivity extends AppCompatActivity {
    ...
    private Size resolution = new Size(1280, 720);  // 分辨率
    private Rational rational = new Rational(9, 16);    // 宽高比
    private Preview preview;            // useCase
    private ImageCapture imageCapture;  // useCase
    private VideoCapture videoCapture;  // useCase
    ...
    private void onFileSaved(File file) {
        ...
        // MediaScannerConnection -> 扫描媒体库 -> 相册可见
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == PERMISSION_CODE) {
            ...
            if (deniedPermission.isEmpty()) {   // 获取到了所需权限
                bindCameraX();
            } else {    // 权限被拒绝
    ...
    private void bindCameraX() {
        CameraX.unbindAll();    // 先解绑所有 useCase
        ...
        // 定义三个 useCase: preview, imageCapture, videoCapture
        ...
        preview.setOnPreviewOutputUpdateListener(new Preview.OnPreviewOutputUpdateListener() {
            ...
            public void onUpdated(Preview.PreviewOutput output) {
                ...
                // 此处有【坑】：需要先 remove，再 add 一次，才能够将信息正确渲染到 TextureView 中
